...
<body>
	<div class="total">
		<div class="notice"><b>COMPLETE</b></div>
		<form >
			<table class="table" >
				<tr>
					<th>No. </th>
				...
				<tr>
					<td><c:out value="${com.c_num }"></c:out> </td>
					<td>
						<a class="move" href='<c:out value="${com.c_num}"/>'>   
							<c:out value="${com.c_title }"></c:out>
						</a>
					</td>
					<td><c:out value="${com.c_id }"></c:out> </td>
					<td><c:out value="${com.c_price }"></c:out> </td>
					<td><fmt:formatDate value="${com.c_date}" pattern="yyyy-MM-dd"/></td>
				</tr>
...
$(function(){
	...
	$(".move").click(function(e){
		...
		formObj.append("<input type='hidden' name='c_num' value='" + value + "'>");
		formObj.attr("action", "/complete/get");
		formObj.submit();
	});
