...
<body>
	...
	<div class="leftMenuT">
		<c:forEach var="mem" items="${list }"></c:forEach>
		<div class="leftMenuA" >
			<span class="material-icons-outlined">face</span>
			<div>의뢰인</div>
			<div>강렬한나무2345 </div>
			<div><button class="changeH">↔ 전문가로 전환</button> </div>
			<div><h3>마이크몽</h3></div>
		...
		<div class="leftMenuB">
			...
			<div class=""><a href="#">승인대기중</a></div>
			<div class=""><a href="#">진행중</a></div>
			<div class=""><a href="#">완료</a></div>
